...
class JobbyJobsControllerTest < ActionController::TestCase
  ...
  test "should create jobby_job" do
    assert_difference('JobbyJob.count') do
      post :create, jobby_job: { challenge: @jobby_job.challenge, city: @jobby_job.city, company: @jobby_job.company, contact: @jobby_job.contact, description: @jobby_job.description, email: @jobby_job.email, follow_up: @jobby_job.follow_up, interview: @jobby_job.interview, interview_info: @jobby_job.interview_info, job_posting_url: @jobby_job.job_posting_url, job_title: @jobby_job.job_title, phone: @jobby_job.phone, rating: @jobby_job.rating, resume_actually_sent: @jobby_job.resume_actually_sent, resume_to_be_sent: @jobby_job.resume_to_be_sent, street_address: @jobby_job.street_address, website: @jobby_job.website, zip_code: @jobby_job.zip_code }
    end
